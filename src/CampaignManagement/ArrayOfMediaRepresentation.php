...
class ArrayOfMediaRepresentation implements \ArrayAccess, \Iterator, \Countable
{
     ...
     *
     * @return MediaRepresentation Return the current element
     */
    public function current()
    {
      return current($this->MediaRepresentation);
    }
    ...
    public function key()
    {
      return key($this->MediaRepresentation);
    }
    ...
    {
      reset($this->MediaRepresentation);
    }
