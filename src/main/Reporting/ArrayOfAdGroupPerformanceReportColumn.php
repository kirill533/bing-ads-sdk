...
class ArrayOfAdGroupPerformanceReportColumn implements \ArrayAccess, \Iterator, \Countable
{
     ...
     *
     * @return AdGroupPerformanceReportColumn Return the current element
     */
    public function current()
    {
      return current($this->AdGroupPerformanceReportColumn);
    }
    ...
    {
      next($this->AdGroupPerformanceReportColumn);
    }
    ...
    public function key()
    {
      return key($this->AdGroupPerformanceReportColumn);
    }
    ...
    {
      reset($this->AdGroupPerformanceReportColumn);
    }
