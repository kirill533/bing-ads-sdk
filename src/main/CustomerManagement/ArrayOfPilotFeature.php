...
class ArrayOfPilotFeature implements \ArrayAccess, \Iterator, \Countable
{
     ...
     *
     * @return PilotFeature Return the current element
     */
    public function current()
    {
      return current($this->PilotFeature);
    }
