...
class ArrayOfKeywordKPI implements \ArrayAccess, \Iterator, \Countable
{
     ...
     *
     * @return KeywordKPI Return the current element
     */
    public function current()
    {
      return current($this->KeywordKPI);
    }
