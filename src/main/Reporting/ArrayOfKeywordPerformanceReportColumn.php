...
class ArrayOfKeywordPerformanceReportColumn implements \ArrayAccess, \Iterator, \Countable
{
     ...
     *
     * @return KeywordPerformanceReportColumn Return the current element
     */
    public function current()
    {
      return current($this->KeywordPerformanceReportColumn);
    }
    ...
    {
      next($this->KeywordPerformanceReportColumn);
    }
    ...
    public function key()
    {
      return key($this->KeywordPerformanceReportColumn);
    }
    ...
    {
      reset($this->KeywordPerformanceReportColumn);
    }
