...
class ArrayOfKeyValuePairOfstringstring implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \PMG\BingAds\CampaignMangagement\ArrayOfKeyValuePairOfstringstring
     */
     ...
     *
     * @return KeyValuePairOfstringstring Return the current element
     */
    public function current()
    {
      return current($this->KeyValuePairOfstringstring);
    }
    ...
    {
      next($this->KeyValuePairOfstringstring);
    }
    ...
    public function key()
    {
      return key($this->KeyValuePairOfstringstring);
    }
    ...
    {
      reset($this->KeyValuePairOfstringstring);
    }
