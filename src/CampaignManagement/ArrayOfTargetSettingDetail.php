...
class ArrayOfTargetSettingDetail implements \ArrayAccess, \Iterator, \Countable
{
     ...
     *
     * @return TargetSettingDetail Return the current element
     */
    public function current()
    {
      return current($this->TargetSettingDetail);
    }
    ...
    public function key()
    {
      return key($this->TargetSettingDetail);
    }
    ...
    {
      reset($this->TargetSettingDetail);
    }
